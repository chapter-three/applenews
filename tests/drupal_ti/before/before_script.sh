...
git clone --depth 1 --branch 0.3.7 https://github.com/chapter-three/AppleNewsAPI.git
git clone --depth 1 --branch 4.6.9 https://github.com/php-curl-class/php-curl-class.git
